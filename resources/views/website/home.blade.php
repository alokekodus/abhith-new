    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-7 about-left">
                ...
                <p class="">With a rapid increase in technology and anything being available at just a click away, people are
                ...
                <p class="">Learning has invariably expanded its horizons and has carved a niche for itself in the larger
                        ...
                        <form id="enquiryFormSubmit">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="name" placeholder="Name" id="name"
                                    maxlength="30" pattern="^[a-zA-Z]+\s?[a-zA-Z]+\s?[a-zA-Z]+"
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="email" placeholder="Email Id" id="email"
                                    pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" title="Please enter a valid email address."
                                    required>
                            </div>
                            <div class="form-group">
            ...
            <div class="col-lg-12">
                <div class="owl-slider">
                    <div id="carousel" class="owl-carousel">
                        ...
                        <div class="item">
                            <div class="upcoming-image"><img src="{{ asset($item['course_pic']) }}" class="w100"></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <ul class="list-inline blog-list">
                    ...
                    <li><span class="icon-Calender-09 calendar-icon"></span><span>{{
                            \Carbon\Carbon::parse($item->created_at)->format('F d, Y') }}</span>
                        <div class="block-ellipsis1">
                            <h4 class="small-heading-black">
                                {!! Illuminate\Support\Str::limit(strip_tags($item->name), $limit = 100, $end = '...')
                                !!}</h4>
                        </div>
