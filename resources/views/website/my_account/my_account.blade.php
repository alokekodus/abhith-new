                            ...
                            <div class="knowledge-pic">
                                ...
                                @if ($user_details != null)
                                    <img src="{{ asset('/files/profile/' . $user_details->image) }}"
                                        ...
                                        style="border:3px solid white;" height="110px" width="110px"
                                ...
                                <form class="row" id="profileForm">
                                    ...
                                    @if ($user_details != null)
                                        ...
                                        title="Please Enter Letters only." value="{{Auth::user()->name}}" required> --}}
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                placeholder="Enter Name" id="name" value="{{ Auth::user()->name }}"
                                                required>
                                        </div>
                                        <div class="form-group col-lg-6 pr10">
                                            <label>Email ID</label>
                                            <input type="email" class="form-control" name="email"
                                                placeholder="Enter Email" id="email" value="{{ Auth::user()->email }}"
                                                required>
                                        </div>
                                        <div class="form-group col-lg-6 pr10">
                                            <label>Mobile number</label>
                                            <input type="text" class="form-control" name="phone"
                                                placeholder="Enter Phone" id="phone" pattern="(0|91)?[6-9][0-9]{9}"
                                    ...
                                    @else
                                        ...
                                        <div class="form-group col-lg-6 pr10">
                                            ...
                                            <input type="text" class="form-control" name="address"
                                                placeholder="Enter Address" id="address"
                                                value="{{ $user_details->address ?? 'NA' }}" required>
                                        </div>
                                    @endif
                                    ...
                                    <div class="avatar-upload">
                                        <div class="avatar-edit">
                                            ...
                                            <input type='file' id="imageUpload" name="image"
                                                accept=".png, .jpg, .jpeg" onchange="previewImage(event)" required>
                                            ...
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item mb-2" role="presentation">
                                                    <button class="nav-link active" id="daily-tab" data-toggle="tab"
                                                        data-target="#daily" type="button" role="tab"
                                                        aria-controls="daily" aria-selected="true">Daily</button>
                                                </li>
