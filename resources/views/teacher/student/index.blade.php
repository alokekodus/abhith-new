                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('teacher.subject.student.report',[Crypt::encrypt($assign_orders[0]->subject->id),Crypt::encrypt($assign_order->order->user->id)])}}"><label class="badge badge-gradient-info"> PROGRESS REPORT <i
