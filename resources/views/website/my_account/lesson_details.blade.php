                            ...
                            @foreach ($topicArticles as $key => $article)
                                <div class="col-lg-6 col-md-6">
                                    <div class="article-div d-flex">
                                        ...
                                        <a target="_blank" href="#" class="btn btn-sm ml-auto" style="background-color: #f2f2f2; font-size: 20px; width: 40px; aspect-ratio: 1/1; border-radius: 50%"><i class="fa fa-eye"></i></a>
                                    </div>
                                </div>
                            @endforeach
                        @else
